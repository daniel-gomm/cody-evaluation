...
\draw[draw=white,fill=black25,line width=0.32pt] (axis cs:1.9625,0) rectangle (axis cs:2.0375,87.366843001);
\draw[draw=white,fill=black25,line width=0pt,postaction={pattern=north east lines, pattern color=white}] (axis cs:2.0375,0) rectangle (axis cs:2.1125,59.535374881);
\end{axis}
